...
// wrapc file define:
#define AUTOTB_TVIN_in "../tv/cdatafile/c.inverter.autotvin_in_r.dat"
#define AUTOTB_TVOUT_in "../tv/cdatafile/c.inverter.autotvout_in_r.dat"
// wrapc file define:
#define AUTOTB_TVIN_out "../tv/cdatafile/c.inverter.autotvin_out_r.dat"
#define AUTOTB_TVOUT_out "../tv/cdatafile/c.inverter.autotvout_out_r.dat"

#define INTER_TCL "../tv/cdatafile/ref.tcl"

// tvout file define:
#define AUTOTB_TVOUT_PC_in "../tv/rtldatafile/rtl.inverter.autotvout_in_r.dat"
// tvout file define:
#define AUTOTB_TVOUT_PC_out "../tv/rtldatafile/rtl.inverter.autotvout_out_r.dat"
...
extern "C" void apatb_inverter_hw(volatile void * __xlx_apatb_param_in, volatile void * __xlx_apatb_param_out) {
    ...
    string AESL_num;{
      ...
      if (rtl_tv_out_file.good()) {
        ...
        if (atoi(AESL_num.c_str()) == AESL_transaction_pc) {
          std::vector<sc_bv<8> > out_pc_buffer(307200);
          int i = 0;
...
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_in)[j];
  ...
  tcl_file.set_num(307200, &tcl_file.in_depth);
...
// print out Transactions
{
  ...
  {  __xlx_offset_byte_param_out = 0*1;
...
sc_bv<8> __xlx_tmp_lv = ((char*)__xlx_apatb_param_out)[j];
  ...
  tcl_file.set_num(307200, &tcl_file.out_depth);
  sprintf(__xlx_sprintf_buffer.data(), "[[/transaction]] \n");
  aesl_fh.write(AUTOTB_TVIN_out, __xlx_sprintf_buffer.data());
}
CodeState = CALL_C_DUT;
inverter_hw_stub_wrapper(__xlx_apatb_param_in, __xlx_apatb_param_out);
