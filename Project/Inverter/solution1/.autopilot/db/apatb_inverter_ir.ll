...
define internal fastcc void @copy_in([307200 x i8]* readonly, [307200 x i8]* noalias, [307200 x i8]* readonly, [307200 x i8]* noalias) unnamed_addr #1 {
entry:
...
; Function Attrs: argmemonly noinline
define internal fastcc void @onebyonecpy_hls.p0a307200i8([307200 x i8]* noalias, [307200 x i8]* noalias readonly) unnamed_addr #2 {
entry:
  %2 = icmp eq [307200 x i8]* %0, null
  %3 = icmp eq [307200 x i8]* %1, null
  %4 = or i1 %2, %3
...
for.loop:                                         ; preds = %for.loop, %copy
  ...
  %dst.addr = getelementptr [307200 x i8], [307200 x i8]* %0, i64 0, i64 %for.loop.idx1
  %src.addr = getelementptr [307200 x i8], [307200 x i8]* %1, i64 0, i64 %for.loop.idx1
...
; Function Attrs: argmemonly noinline
define internal fastcc void @copy_out([307200 x i8]*, [307200 x i8]* noalias readonly, [307200 x i8]*, [307200 x i8]* noalias readonly) unnamed_addr #4 {
entry:
...
declare void @apatb_inverter_hw(i8*, i8*)

define void @inverter_hw_stub_wrapper(i8*, i8*) #5 {
entry:
  %2 = bitcast i8* %0 to [307200 x i8]*
  %3 = bitcast i8* %1 to [307200 x i8]*
  call void @copy_out([307200 x i8]* null, [307200 x i8]* %2, [307200 x i8]* null, [307200 x i8]* %3)
  %4 = bitcast [307200 x i8]* %2 to i8*
  %5 = bitcast [307200 x i8]* %3 to i8*
  call void @inverter_hw_stub(i8* %4, i8* %5)
  call void @copy_in([307200 x i8]* null, [307200 x i8]* %2, [307200 x i8]* null, [307200 x i8]* %3)
  ret void
}

declare void @inverter_hw_stub(i8*, i8*)
